...
class Saqla(ToDoList):
    # def __init__(self, fayl_nomi, bajarilgan, bajarilmagan):
    #     super().__init__(fayl_nomi)
        # self.bajarilgan = []
        # self.bajarilmagan = []
    def bajarilgan(self):
        print("Bajarilganlar")
        for vazifa in self.vazifalar:
            if vazifa['holat'] == True:
                print(vazifa)
    def bajarilmagan(self):
        print("Bajarilmaganlar")
        for vazifa in self.vazifalar:
            if vazifa['holat'] == False:
                print(vazifa)
# Loyihani boshqarish
todo = ToDoList()
